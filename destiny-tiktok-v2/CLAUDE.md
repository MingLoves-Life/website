...
### 这个项目是 destiny-tiktok-v2

| | destiny-tiktok-v1 | destiny-tiktok-v2（本目录）|
|---|---|---|
| **视频内容** | "为什么努力留不住钱" — 数字反差Hook，讲命理机制，引流到网站免费测 | "粉丝留言解读" — 真实粉丝留了生日，公开兑现解读，引导更多人评论区留生日 |
| **核心策略** | 痛点+悬念，建立命理认知 | 社交证明+真人手算，建立信任 |
| **目标动作** | 点主页链接做免费测算 | 在评论区留生日 |
| **状态** | 已完成并发布 | 制作中 |

**规则：做 V2 视频只在本目录操作，不要动 `destiny-tiktok-v1/`。**
